...
import (
	...
	"github.com/babugeet/test-webserver-operator/internal/controller"
...
func init() {
	...
	utilruntime.Must(ldhctlrv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "f7b24a17.linuxdatahub.com",
